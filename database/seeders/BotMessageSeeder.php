...
class BotMessageSeeder extends Seeder
{
    public function run(): void
    {
        $messages = [
            ...
            // حساب پنل XMPlus (منوی ربات + داشبورد)
            [
                'key' => 'btn_xmplus_panel_account',
                'category' => 'buttons',
                'title' => 'دکمه: حساب پنل XMPlus',
                'content' => '🔐 حساب پنل XMPlus',
                'description' => 'دکمهٔ منو وقتی panel_type=xmplus است. حدود ۶۴ کاراکتر برای اینلاین تلگرام.',
            ],
            [
                'key' => 'msg_xmplus_panel_account_empty',
                'category' => 'messages',
                'title' => 'پیام: حساب XMPlus — بدون نام کاربری',
                ...
                'description' => 'متغیر: {panel_url}',
            ],
            [
                'key' => 'msg_xmplus_panel_account',
                'category' => 'messages',
                'title' => 'پیام: حساب XMPlus — با نام کاربری و رمز',
                ...
                'description' => 'متغیرها: {panel_url}, {email}, {password}',
            ],
            ...
            [
                ...
                'content' => "⏳ پرداخت این سفارش هنوز در BypassNET نهایی نشده است.\nبعد از تکمیل پرداخت، دکمه «✅ پرداخت کردم، بررسی کن» را بزنید.",
            ...
            [
                ...
                'content' => "⚠️ فاکتور در BypassNET با وضعیت Paid ثبت شده، اما API هنوز لینک اشتراک (subscription) را برنمی‌گرداند.\n\nاحتمالاً سرویس در پنل هنوز ساخته نشده، نیاز به تأیید دستی دارد، یا نسخهٔ پنل با Client API هم‌خوان نیست.\n\nاگر فاکتور فقط با ویرایش مستقیم دیتابیس به Paid رسیده (بدون تکمیل مسیر پرداخت داخل پنل)، BypassNET معمولاً سرویس و لینک نمی‌سازد؛ باید از مسیر پنل یا invoice/pay با درگاه نمایندگی تسویه شود.\n\n🌐 ورود به پنل کاربری: {panel_url}\n📧 ایمیل پنل: {email}\n📄 شناسه فاکتور (invid): {invoice_id}\n🛒 شماره سفارش فروشگاه: #{order_id}\n\nلطفاً از بخش «سرویس‌ها / اشتراک» همان پنل لینک را بردارید. اگر سرویسی دیده نمی‌شود با پشتیبانی هاست BypassNET تماس بگیرید.",
